...
$query = 'CREATE TABLE IF NOT EXISTS MoYo_site_user (
...
$query = 'CREATE TABLE IF NOT EXISTS MoYo_site_user_playlistsongs (
        ...
        FOREIGN KEY (user_id) REFERENCES MoYo_site_user(user_id)
    )
    ENGINE=MyISAM';
mysql_query($query, $db) or die (mysql_error($db));

// populate the user table
$query = 'INSERT IGNORE INTO MoYo_site_user
        (user_id, username, password) 
    VALUES
        (1, "yuan", PASSWORD("1234"))';
